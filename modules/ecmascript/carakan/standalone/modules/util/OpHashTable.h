...
public:
	...
	OP_STATUS Add(INT32 data) {return OpGenericPointerSet::Add((void*)(UINTPTR)data);}
	BOOL Contains(INT32 data) const {return OpGenericPointerSet::Contains((void*)(UINTPTR)data);}
	OP_STATUS Remove(INT32 data) {return OpGenericPointerSet::Remove((void*)(UINTPTR)data);}
